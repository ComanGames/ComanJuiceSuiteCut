        ...
        <div class="bx-thumbnail-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div id="bx-pager">
                            <a data-slide-index="0" href=""><img src="//i.ytimg.com/vi/PUoLUaeypm8/mqdefault.jpg" alt="thumbnail 1"/></a>
		...
		<div class="row">
			...
			<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
				<div class="section-title">
					<h5 class="wow bounceIn">HOW WE CAN HELP</h5>
					<!--<h2 class="heading">WHY CHOOSE US</h2>-->
					<hr>
					<p>We're professional creative studio specialized on animation, film and VR production. By crafting informative and appealing video content we're helping companies and businesses to promote their brands. </p>
				</div>
			</div>
			...
			<div id="owl-work" class="owl-carousel">
			    ...
			    <div class="item col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
			        <i class="icon-basket medium-icon"></i>
			        <h3>HOLLYWOOD EFFECTS</h3>
			        <hr>
			        <p>Our team is capable of adding eye-catching spectacular effects to your videos in order to make them as worth-seeing as Hollywood ones.</p>
			    </div>
